(setq pyel-test-py-functions '("def pyel_test_rfind_method_401(n):
 x = 'asdf'
 y = 'abxabxab'
 if n == 1:
  return x.rfind('sd')
 ...
 if n == 2:
  return y.rfind('ab')" "def pyel_test_ljust_method_400():
 x = 'ab'
 return x.ljust(10)" "def pyel_test_rjust_method_399():
 x = 'ab'
 return x.rjust(10)" "def pyel_test_rpartition_method_398():
 x = 'abcdefghi'
 return x.rpartition('c')" "def pyel_test_partition_method_397():
 x = 'abcdefghi'
 return x.partition('c')" "def pyel_test_rsplit_method_396():
 x = 'a b c'
 y = x.rsplit()
 return y" "def pyel_test_rsplit_method_395(n):
 y = 'a x b x d x'.rsplit()
 if n == 1:
  return y

 if n == 2:
  return len(y)" "def pyel_test_lstrip_method_394():
 x = 'hello'
 return x.lstrip('hlo')" "def pyel_test_rstrip_method_393():
 x = 'hello'
 return x.rstrip('hlo')" "def pyel_test_startswith_method_392():
 x = 'abcde'
 return x.startswith('.')" "def pyel_test_swapcase_method_391():
 x = 'aaBB1'
 return x.swapcase()" "def pyel_test_title_method_390():
 x = '2dd'
 return x.title()" "def pyel_test_zfill_method_389():
 a = 'asdf'
 return a.zfill(10)" "def pyel_test_isalnum_method_388():
 x = '23'
 return x.isalnum()" "def pyel_test_isalpha_method_387():
 x = 'asd'
 return x.isalpha()" "def pyel_test_istitle_method_386(n):
 a = 'sldk'
 b = 'Dsldk'
 c = 'aDsldk'
 if n == 1:
 ...
 if n == 3:
  return c.istitle()" "def pyel_test_isupper_method_385(n):
 a = 'A'
   b = 'a'
   c = 'Aa'
 if n == 1:
 ...
 if n == 3:
  return c.isupper()" "def pyel_test_islower_method_384(n):
 a = 'A'
 b = 'a'
 c = 'Aa'
 if n == 1:
 ...
 if n == 3:
  return c.islower()" "def pyel_test_copy_method_383(n):
 ...
 if n == 2:
  return x[1] is z[1]" "def pyel_test_popitem_method_382(n):
 x = {1:'one',2:'two',3:'three'}
 y = x.popitem()
 if n == 1:
  return y
 ...
 if n == 2:
  return repr(x)" "def pyel_test_values_method_381(n):
 x = {1:'one',2:'two',3:'three'}
 y = {8 : 88}
 z = {}
 if n == 1:
 ...
 if n == 3:
  return z.values()" "def pyel_test_keys_method_380(n):
 x = {1:'one',2:'two',3:'three'}
 y = {8 : 88}
 z = {}
 if n == 1:
 ...
 if n == 3:
  return z.keys()" "def pyel_test_items_method_379(n):
 x = {1:'one',2:'two',3:'three'}
 y = {8 : 88}
 z = {}
 if n == 1:
 ...
 if n == 3:
  return z.items()" "def pyel_test_get_method_378(n):
 x = {1:'one',2:'two',3:'three'}
 if n == 1:
  return x[1]
 ...
 if n == 4:
  return x.get(4, 'd')" "def pyel_test_strip_method_377():
 x = 'hello'
 return x.strip('hlo')" "def pyel_test_split_method_376():
 x = 'a b c'
 y = x.split()
 return y" "def pyel_test_split_method_375(n):
 y = 'a x b x d x'.split()
 if n == 1:
  return y

 if n == 2:
  return len(y)" "def pyel_test_upper_method_374(n):
 x = 'aB'
 y = x
 y = x.upper()
 if n == 1:
 ...
 if n == 2:
  return x" "def pyel_test_lower_method_373(n):
 x = 'aB'
 y = x
 y = x.lower()
 if n == 1:
 ...
 if n == 2:
  return x" "def pyel_test_reverse_method_372(n):
 x = [1,2,3]
 y = x
 x.reverse()
 if n == 1:
 ...
 if n == 2:
  return x is y" "def pyel_test_pop_method_371(n):
 x = [[1],'s',(2,), 1, 4]
 y = x
 a = x.pop()
 b = x.pop(0)
 ...
 if n == 2:
  return repr(x)" "def pyel_test_extend_method_369(n):
 x = [1]
 y = x
 x.extend([1,'2',(3,)])
 if n == 1:
 ...
 if n == 2:
  return x" "def pyel_test_count_method_365(n):
 x = [1,2,3,3,[2],'s']
 if n == 1:
  return x.count(3)
 ...
 if n == 4:
  return x.count('s')" "def pyel_test_count_method_364(n):
 x = (1,2,3,3,[2],'s')
 if n == 1:
  return x.count(3)
 ...
 if n == 4:
  return x.count('s')" "def pyel_test_remove_method_363():
 x = [1,'2','2',(1,)]
 y = x
 x.remove('2')
 return x is y" "def pyel_test_remove_method_362():
 x = [1,'2','2',(1,)]
 x.remove('2')
 return x" "def pyel_test_remove_method_361():
 x = [1,'2','2',(1,)]
 x.remove(1)
 return x" "def pyel_test_remove_method_360():
 x = [1,'2','2',(1,)]
 x.remove((1,))
 return x" "def pyel_test_index_method_359(n):
 x = [1,(1,2),'5']
 if n == 1:
  return x.index(1)
 ...
 if n == 3:
  return x.index('5')" "def pyel_test_index_method_358(n):
 x = 'importantstring'
 if n == 1:
  return x.index('t')
 ...
 if n == 4:
  return x.index(x)" "def pyel_test_index_method_357():
 x = 'str.ing'
 return x.index('.')" "def pyel_test_index_method_356(n):
 x = (1,2,'tree',(3,))
 if n == 1:
  return x.index(1)
 ...
 if n == 3:
  return x.index((3,))" "def pyel_test_find_method_355():
 x = 'asdf'
 return x.find('sd')" "def pyel_test_insert_354(n):
 x = [1,2,3]
 y = x
 x.insert(1,'hi')
 if n == 1:
 ...
 if n == 2:
  return x is y" "def pyel_test_append_353(n):
 a = [1,2,3]
 c = ['a','a']
 b = a
 a.append('hi')
 ...
 if n == 5:
  return e" "def pyel_test_enumerate_function_352():
 class a:
  x = 5
  def __iter__(self):
   return self
  def __next__(self):
   ...
   raise StopIteration
 obj = a()
 return enumerate(obj)" "def pyel_test_dict_function_351():
 a = [('ab'),['b', 5],('c',8)]
 x = dict(a)
 return repr(x)" "def pyel_test_dict_function_350():
 class a:
  x = 5
  def __iter__(self):
   return self
 ...
 o = a()
 x = dict(o)
 return repr((x))" "def pyel_test_float_function_349(n):
 x = '3.1'
 y = ['4']
 z = 2
 a = 3.3
 ...
 if n == 4:
  return float(a)" "def pyel_test_float_function_348():
 class test:
  def __float__(self):
   return 342.1
 o = test()
 return float(o)" "def pyel_test_int_function_347(n):
 x = '3'
 y = ['4']
 z = 2
 a = 3.3
 ...
 if n == 4:
  return int(a)" "def pyel_test_int_function_346():
 class test:
  def __int__(self):
   return 342
 o = test()
 return int(o)" "def pyel_test_abs_function_345():
 class C:
  def __abs__(self):
   'doc'
   return 'hi'
 obj = C()
 return abs(obj)" "def pyel_test_type_344(n):
 class testc: pass
 x = testc()
 y = type(x)
 if n == 1:
 ...
 if n == 2:
  return y is testc" "def pyel_test_str_343():
 class strtest:
  def __init__ (self, n):
   self.x = n
  def __str__(self):
 ...
 obj = strtest(4)
 return str(obj)" "def pyel_test_list_function_342(n):
 a = [1]
 b = [a,1]
 c = list(b)
 if n == 1:
 ...
 if n == 2:
  return c[0] is a" "def pyel_test_list_function_340(n):
 s = '123'
 l = [1,2,3]
 tu = (1,2,3,)
 d = {1:'1',2:'2',3:'3'}
 ...
 if n == 4:
  return list(d)" "def pyel_test_list_function_339():
 class a:
  x = 5
  def __iter__(self):
   return self
  def __next__(self):
   ...
   raise StopIteration
 obj = a()
 return list(obj)" "def pyel_test_len_function_338(n):
 a = [1,2,3,'5']
 b = []
 c = 'str'
 d = (1,2,3,4)
 ...
 if n == 4:
  return len(d)" "def pyel_test_dict_comprehensions_307(n):
 x = {x: [y*y for y in range(x)] for x in range(20)}
 if n == 1:
  return hash_table_count(x)

 if n == 2:
  return x[3],x[5],x[10]" "def pyel_test_list_comprehensions_306(n):
 ...
 if n == 2:
  return transposed" "def pyel_test_continue_299():
 l = [0]
 y = 8;
 while y > 0:
  y = y -1
  if y % 2 == 0:
   continue
  l.append(y)
 return l" "def pyel_test_continue_298():
 x = [0]
 c = 0
 while c < 3:
  c = c + 1
 ...
 while x < 10:
  ...
  if x == 3:
   break
 return x" "def pyel_test_break_296():
 x = [0]
 c = 0
 while c < 3:
  c = c + 1
 ...
 if n == 4:
  x /= 4
  return x" "def pyel_test_aug_assign_294(n):
 x = [2]
 if n == 1:
  x[0] += 3
  return x[0]
 ...
 if n == 4:
  x[0] /= 4
  return x[0]" "def pyel_test_aug_assign_293(n):
 class a:
  x = 2
 if n == 1:
  a.x += 3
 ...
 if n == 4:
  a.x /= 4
  return a.x" "def pyel_test_for_loop_280():
 x = []
 for a in range(5):
  x.append(a)
 ...
 for a in range(5):
  for b in range(5):
   n = n + a + b
 return n" "def pyel_test_for_loop_276():
 x = []
 for a in range(100):
  if (a % 2 == 0):
   continue
 ...
 for a in tup:
  ...
  if a > 10:
   break
  x.append(a)
 return x" "def pyel_test_for_loop_272():
 x = []
 for a in 'string':
  x.append(a)
 return x" "def pyel_test_for_loop_271(n):
 x = []
 c = 0
 def getstr():
  global c
 ...
 if n == 2:
  return c" "def pyel_test_for_loop_270():
 class a:
  x = 5
  def __iter__(self):
   return self
 ...
 for n in get_obj():
  x.append(n)
 return x" "def pyel_test_special_method_lookup_263(n):
 class adder:
  def __init__(self, n):
   self.x = n
  def __call__ (self, n):
 ...
 if n == 3:
  return d.__call__" "def pyel_test_objects_262(n):
 class tclass():
  '''a test class'''
  cvar = 12
  def __init__(self, x):
 ...
 if n == 16:
  ...
  y = x.sixmore
  x.a = 2
  return y()" "def pyel_test_objects_261(n):
 class one:
  def __init__(self,x):
   self.n = x
  def m(self):
 ...
 if n == 2:
  return x.other.m()" "def pyel_test_mod_op_203():
 a = 3
 b = 5
 return b % a" "def pyel_test_bin_ops_202(n):
 a = 3
 b = 5
 if n == 1:
  return a & b
 ...
 if n == 3:
  return a ^ b" "def pyel_test_div_op_201(n):
 a = 9
 b = 4
 if n == 1:
  return a / b
 ...
 if n == 2:
  return a // b" "def pyel_test_pow_op_200():
 n1 = 2
 n2 = 4
 return n1 ** n2" "def pyel_test_mult_op_199(n):
 n1 = 2
 n2 = 4
 s = 's'
 if n == 1:
 ...
 if n == 3:
  return n1 * s" "def pyel_test_sub_op_198():
 n1 = 5
 n2 = 3
 return n1 - n2" "def pyel_test_add_op_197(n):
 n1 = 2
 n2 = 5
 s1 = 'asd'
 s2 = 'df'
 ...
 if n == 4:
  return v1 + v2" "def pyel_test_add_op_196():
 class test:
  def __init__(self, n):
   message('init')
   self.n = n*2
 ...
 x = test(5)
 y = test(2)
 return x + y" "def pyel_test_function_arguments_195(n):
 ...
 if n == 9:
  return repr(func(x = 's',__b = 324,__a = 'n',d = 2))" "def pyel_test_def_194(n):
 def a():
   return 0
...
(ert-deftest pyel-test-function_arguments-1 nil (equal (eval (pyel "pyel_test_function_arguments_195(1)")) "[1, 2, 1, \"two\", [], {}]"))
(ert-deftest pyel-test-function_arguments-2 nil (equal (eval (pyel "pyel_test_function_arguments_195(2)")) "[1, 2, 3, \"two\", [], {}]"))
(ert-deftest pyel-test-function_arguments-3 nil (equal (eval (pyel "pyel_test_function_arguments_195(3)")) "[1, 2, 3, 4, [], {}]"))
(ert-deftest pyel-test-function_arguments-4 nil (equal (eval (pyel "pyel_test_function_arguments_195(4)")) "[1, 2, 3, 4, [5], {}]"))
(ert-deftest pyel-test-function_arguments-5 nil (equal (eval (pyel "pyel_test_function_arguments_195(5)")) "[1, 2, 3, 4, [5, 6], {}]"))
(ert-deftest pyel-test-function_arguments-6 nil (equal (eval (pyel "pyel_test_function_arguments_195(6)")) "[1, 2, 3, 4, [5, 6], {x: \"s\"}]"))
(ert-deftest pyel-test-function_arguments-7 nil (equal (eval (pyel "pyel_test_function_arguments_195(7)")) "[1, 2, 3, 4, [5, 6], {y: 23, x: \"s\"}]"))
(ert-deftest pyel-test-function_arguments-8 nil (equal (eval (pyel "pyel_test_function_arguments_195(8)")) "[\"n\", 324, 1, \"two\", [], {x: \"s\"}]"))
(ert-deftest pyel-test-function_arguments-9 nil (equal (eval (pyel "pyel_test_function_arguments_195(9)")) "[\"n\", 324, 1, 2, [], {x: \"s\"}]"))
(ert-deftest pyel-test-add_op-1 nil (equal (eval (pyel "pyel_test_add_op_196()")) 14))
(ert-deftest pyel-test-add_op-2 nil (equal (eval (pyel "pyel_test_add_op_197(1)")) 10))
(ert-deftest pyel-test-add_op-3 nil (equal (eval (pyel "pyel_test_add_op_197(2)")) "asddf"))
(ert-deftest pyel-test-add_op-4 nil (equal (eval (pyel "pyel_test_add_op_197(3)")) (quote (1 3 "a"))))
(ert-deftest pyel-test-add_op-5 nil (equal (eval (pyel "pyel_test_add_op_197(4)")) [1 2 3]))
(ert-deftest pyel-test-sub_op-1 nil (equal (eval (pyel "pyel_test_sub_op_198()")) 2))
(ert-deftest pyel-test-mult_op-1 nil (equal (eval (pyel "pyel_test_mult_op_199(1)")) 8))
(ert-deftest pyel-test-mult_op-2 nil (equal (eval (pyel "pyel_test_mult_op_199(2)")) "ss"))
(ert-deftest pyel-test-mult_op-3 nil (equal (eval (pyel "pyel_test_mult_op_199(3)")) "ss"))
(ert-deftest pyel-test-pow_op-1 nil (equal (eval (pyel "pyel_test_pow_op_200()")) 16))
(ert-deftest pyel-test-div_op-1 nil (equal (eval (pyel "pyel_test_div_op_201(1)")) 2.25))
(ert-deftest pyel-test-div_op-2 nil (equal (eval (pyel "pyel_test_div_op_201(2)")) 2))
(ert-deftest pyel-test-bin_ops-1 nil (equal (eval (pyel "pyel_test_bin_ops_202(1)")) 0))
(ert-deftest pyel-test-bin_ops-2 nil (equal (eval (pyel "pyel_test_bin_ops_202(2)")) 7))
(ert-deftest pyel-test-bin_ops-3 nil (equal (eval (pyel "pyel_test_bin_ops_202(3)")) 6))
(ert-deftest pyel-test-mod_op-1 nil (equal (eval (pyel "pyel_test_mod_op_203()")) 2))
(ert-deftest pyel-test-objects-1 nil (equal (eval (pyel "pyel_test_objects_261(1)")) 5))
(ert-deftest pyel-test-objects-2 nil (equal (eval (pyel "pyel_test_objects_261(2)")) 6))
(ert-deftest pyel-test-objects-3 nil (equal (eval (pyel "pyel_test_objects_262(1)")) "tclass"))
(ert-deftest pyel-test-objects-4 nil (equal (eval (pyel "pyel_test_objects_262(2)")) (lambda (self) (getattr self a))))
(ert-deftest pyel-test-objects-5 nil (equal (eval (pyel "pyel_test_objects_262(3)")) (lambda (self n) (setattr self a n))))
(ert-deftest pyel-test-objects-6 nil (equal (eval (pyel "pyel_test_objects_262(4)")) 12))
(ert-deftest pyel-test-objects-7 nil (equal (eval (pyel "pyel_test_objects_262(5)")) "hi"))
(ert-deftest pyel-test-objects-8 nil (equal (eval (pyel "pyel_test_objects_262(6)")) 23))
(ert-deftest pyel-test-objects-9 nil (equal (eval (pyel "pyel_test_objects_262(7)")) 19))
(ert-deftest pyel-test-objects-10 nil (equal (eval (pyel "pyel_test_objects_262(8)")) (lambda (self) nil (pyel-+ (getattr self cvar) 5))))
(ert-deftest pyel-test-objects-11 nil (equal (eval (pyel "pyel_test_objects_262(9)")) "<class 'object'>"))
(ert-deftest pyel-test-objects-12 nil (equal (eval (pyel "pyel_test_objects_262(10)")) t))
(ert-deftest pyel-test-objects-13 nil (equal (eval (pyel "pyel_test_objects_262(11)")) "tclass"))
(ert-deftest pyel-test-objects-14 nil (equal (eval (pyel "pyel_test_objects_262(12)")) 14))
(ert-deftest pyel-test-objects-15 nil (equal (eval (pyel "pyel_test_objects_262(13)")) 2))
(ert-deftest pyel-test-objects-16 nil (equal (eval (pyel "pyel_test_objects_262(14)")) [4 12]))
(ert-deftest pyel-test-objects-17 nil (equal (eval (pyel "pyel_test_objects_262(15)")) 10))
(ert-deftest pyel-test-objects-18 nil (equal (eval (pyel "pyel_test_objects_262(16)")) 8))
(ert-deftest pyel-test-special_method_lookup-1 nil (equal (eval (pyel "pyel_test_special_method_lookup_263(1)")) 16))
(ert-deftest pyel-test-special_method_lookup-2 nil (equal (eval (pyel "pyel_test_special_method_lookup_263(2)")) "<bound method adder.__call__ of adder object at 0x18b071>"))
(ert-deftest pyel-test-special_method_lookup-3 nil (equal (eval (pyel "pyel_test_special_method_lookup_263(3)")) (lambda nil nil "hi")))
(ert-deftest pyel-test-for_loop-1 nil (equal (eval (pyel "pyel_test_for_loop_270()")) (quote ("5" "4" "3" "2" "1"))))
(ert-deftest pyel-test-for_loop-2 nil (equal (eval (pyel "pyel_test_for_loop_271(1)")) (quote ("q" "w" "e" "r" "t" "y"))))
(ert-deftest pyel-test-for_loop-3 nil (equal (eval (pyel "pyel_test_for_loop_271(2)")) 1))
(ert-deftest pyel-test-for_loop-4 nil (equal (eval (pyel "pyel_test_for_loop_272()")) (quote ("s" "t" "r" "i" "n" "g"))))
(ert-deftest pyel-test-for_loop-5 nil (equal (eval (pyel "pyel_test_for_loop_273()")) (quote (1 3 5 7 9))))
(ert-deftest pyel-test-for_loop-6 nil (equal (eval (pyel "pyel_test_for_loop_274()")) (quote ((1 2) ("3" "4") (5 6)))))
(ert-deftest pyel-test-for_loop-7 nil (equal (eval (pyel "pyel_test_for_loop_275()")) (quote (2 4 6 8))))
(ert-deftest pyel-test-for_loop-8 nil (equal (eval (pyel "pyel_test_for_loop_276()")) (quote (1 3 5 7 9))))
(ert-deftest pyel-test-for_loop-9 nil (equal (eval (pyel "pyel_test_for_loop_277()")) 100))
(ert-deftest pyel-test-for_loop-10 nil (equal (eval (pyel "pyel_test_for_loop_278()")) (quote ((1 2 1 1 1) ("3" "4" "x" "a" "3") (5 6 "a" 1 5)))))
(ert-deftest pyel-test-for_loop-11 nil (equal (eval (pyel "pyel_test_for_loop_279()")) (quote ((1 2) ("3" "4") (5 6)))))
(ert-deftest pyel-test-for_loop-12 nil (equal (eval (pyel "pyel_test_for_loop_280()")) (quote (0 1 2 3 4))))
(ert-deftest pyel-test-aug_assign-1 nil (equal (eval (pyel "pyel_test_aug_assign_293(1)")) 5))
(ert-deftest pyel-test-aug_assign-2 nil (equal (eval (pyel "pyel_test_aug_assign_293(2)")) 6))
(ert-deftest pyel-test-aug_assign-3 nil (equal (eval (pyel "pyel_test_aug_assign_293(3)")) 1))
(ert-deftest pyel-test-aug_assign-4 nil (equal (eval (pyel "pyel_test_aug_assign_293(4)")) 0.5))
(ert-deftest pyel-test-aug_assign-5 nil (equal (eval (pyel "pyel_test_aug_assign_294(1)")) 5))
(ert-deftest pyel-test-aug_assign-6 nil (equal (eval (pyel "pyel_test_aug_assign_294(2)")) 6))
(ert-deftest pyel-test-aug_assign-7 nil (equal (eval (pyel "pyel_test_aug_assign_294(3)")) 1))
(ert-deftest pyel-test-aug_assign-8 nil (equal (eval (pyel "pyel_test_aug_assign_294(4)")) 0.5))
(ert-deftest pyel-test-aug_assign-9 nil (equal (eval (pyel "pyel_test_aug_assign_295(1)")) 5))
(ert-deftest pyel-test-aug_assign-10 nil (equal (eval (pyel "pyel_test_aug_assign_295(2)")) 6))
(ert-deftest pyel-test-aug_assign-11 nil (equal (eval (pyel "pyel_test_aug_assign_295(3)")) 1))
(ert-deftest pyel-test-aug_assign-12 nil (equal (eval (pyel "pyel_test_aug_assign_295(4)")) 0.5))
(ert-deftest pyel-test-break-1 nil (equal (eval (pyel "pyel_test_break_296()")) (quote (0 1 2 3 "b" 1 2 3 "b" 1 2 3 "b"))))
(ert-deftest pyel-test-break-2 nil (equal (eval (pyel "pyel_test_break_297()")) 3))
(ert-deftest pyel-test-continue-1 nil (equal (eval (pyel "pyel_test_continue_298()")) (quote (0 1 "c" 3 "c" 5 1 "c" 3 "c" 5 1 "c" 3 "c" 5))))
(ert-deftest pyel-test-continue-2 nil (equal (eval (pyel "pyel_test_continue_299()")) (quote (0 7 5 3 1))))
(ert-deftest pyel-test-list_comprehensions-1 nil (equal (eval (pyel "pyel_test_list_comprehensions_306(1)")) (quote ((1 5 9) (2 6 10) (3 7 11) (4 8 12)))))
(ert-deftest pyel-test-list_comprehensions-2 nil (equal (eval (pyel "pyel_test_list_comprehensions_306(2)")) (quote ((1 5 9) (2 6 10) (3 7 11) (4 8 12)))))
(ert-deftest pyel-test-dict_comprehensions-1 nil (equal (eval (pyel "pyel_test_dict_comprehensions_307(1)")) 20))
(ert-deftest pyel-test-dict_comprehensions-2 nil (equal (eval (pyel "pyel_test_dict_comprehensions_307(2)")) [(0 1 4) (0 1 4 9 16) (0 1 4 9 16 25 36 49 64 81)]))
(ert-deftest pyel-test-len_function-4 nil (equal (eval (pyel "pyel_test_len_function_338(1)")) 4))
(ert-deftest pyel-test-len_function-5 nil (equal (eval (pyel "pyel_test_len_function_338(2)")) 0))
(ert-deftest pyel-test-len_function-6 nil (equal (eval (pyel "pyel_test_len_function_338(3)")) 3))
(ert-deftest pyel-test-len_function-7 nil (equal (eval (pyel "pyel_test_len_function_338(4)")) 4))
(ert-deftest pyel-test-list_function-1 nil (equal (eval (pyel "pyel_test_list_function_339()")) (quote ("5" "4" "3" "2" "1"))))
(ert-deftest pyel-test-list_function-2 nil (equal (eval (pyel "pyel_test_list_function_340(1)")) ["1" (\, "2") (\, "3")]))
(ert-deftest pyel-test-list_function-3 nil (equal (eval (pyel "pyel_test_list_function_340(2)")) [1 (\, 2) (\, 3)]))
(ert-deftest pyel-test-list_function-4 nil (equal (eval (pyel "pyel_test_list_function_340(3)")) [1 (\, 2) (\, 3)]))
(ert-deftest pyel-test-list_function-5 nil (equal (eval (pyel "pyel_test_list_function_340(4)")) [3 (\, 2) (\, 1)]))
(ert-deftest pyel-test-list_function-8 nil (equal (eval (pyel "pyel_test_list_function_341(1)")) (quote ((1) 1))))
(ert-deftest pyel-test-list_function-9 nil (equal (eval (pyel "pyel_test_list_function_341(2)")) t))
(ert-deftest pyel-test-list_function-10 nil (equal (eval (pyel "pyel_test_list_function_342(1)")) nil))
(ert-deftest pyel-test-list_function-11 nil (equal (eval (pyel "pyel_test_list_function_342(2)")) t))
(ert-deftest pyel-test-list_function-12 nil (equal (eval (pyel "pyel_test_list_function_342(3)")) t))
(ert-deftest pyel-test-str-1 nil (equal (eval (pyel "pyel_test_str_343()")) "str4"))
(ert-deftest pyel-test-type-1 nil (equal (eval (pyel "pyel_test_type_344(1)")) "<class 'testc'>"))
(ert-deftest pyel-test-type-2 nil (equal (eval (pyel "pyel_test_type_344(2)")) t))
(ert-deftest pyel-test-abs_function-1 nil (equal (eval (pyel "pyel_test_abs_function_345()")) "hi"))
(ert-deftest pyel-test-int_function-1 nil (equal (eval (pyel "pyel_test_int_function_346()")) 342))
(ert-deftest pyel-test-int_function-2 nil (equal (eval (pyel "pyel_test_int_function_347(1)")) 3))
(ert-deftest pyel-test-int_function-3 nil (equal (eval (pyel "pyel_test_int_function_347(2)")) 4))
(ert-deftest pyel-test-int_function-4 nil (equal (eval (pyel "pyel_test_int_function_347(3)")) 2))
(ert-deftest pyel-test-int_function-5 nil (equal (eval (pyel "pyel_test_int_function_347(4)")) 3))
(ert-deftest pyel-test-float_function-1 nil (equal (eval (pyel "pyel_test_float_function_348()")) 342.1))
(ert-deftest pyel-test-float_function-2 nil (equal (eval (pyel "pyel_test_float_function_349(1)")) 3.1))
(ert-deftest pyel-test-float_function-3 nil (equal (eval (pyel "pyel_test_float_function_349(2)")) 4.0))
(ert-deftest pyel-test-float_function-4 nil (equal (eval (pyel "pyel_test_float_function_349(3)")) 2.0))
(ert-deftest pyel-test-float_function-5 nil (equal (eval (pyel "pyel_test_float_function_349(4)")) 3.3))
(ert-deftest pyel-test-dict_function-1 nil (equal (eval (pyel "pyel_test_dict_function_350()")) "{5: 25, 4: 16, 3: 9, 2: 4, 1: 1}"))
(ert-deftest pyel-test-dict_function-2 nil (equal (eval (pyel "pyel_test_dict_function_351()")) "{\"a\": \"b\", \"b\": 5, \"c\": 8}"))
(ert-deftest pyel-test-enumerate_function-1 nil (equal (eval (pyel "pyel_test_enumerate_function_352()")) (quote ((0 "5") (1 "4") (2 "3") (3 "2") (4 "1")))))
(ert-deftest pyel-test-append-1 nil (equal (eval (pyel "pyel_test_append_353(1)")) (quote (1 2 3 "hi"))))
(ert-deftest pyel-test-append-2 nil (equal (eval (pyel "pyel_test_append_353(2)")) t))
(ert-deftest pyel-test-append-3 nil (equal (eval (pyel "pyel_test_append_353(3)")) t))
(ert-deftest pyel-test-append-4 nil (equal (eval (pyel "pyel_test_append_353(4)")) t))
(ert-deftest pyel-test-append-5 nil (equal (eval (pyel "pyel_test_append_353(5)")) (quote (3))))
(ert-deftest pyel-test-insert-1 nil (equal (eval (pyel "pyel_test_insert_354(1)")) (quote (1 "hi" 2 3))))
(ert-deftest pyel-test-insert-2 nil (equal (eval (pyel "pyel_test_insert_354(2)")) t))
(ert-deftest pyel-test-find_method-1 nil (equal (eval (pyel "pyel_test_find_method_355()")) 1))
(ert-deftest pyel-test-index_method-1 nil (equal (eval (pyel "pyel_test_index_method_356(1)")) 0))
(ert-deftest pyel-test-index_method-2 nil (equal (eval (pyel "pyel_test_index_method_356(2)")) 2))
(ert-deftest pyel-test-index_method-3 nil (equal (eval (pyel "pyel_test_index_method_356(3)")) 3))
(ert-deftest pyel-test-index_method-4 nil (equal (eval (pyel "pyel_test_index_method_357()")) 3))
(ert-deftest pyel-test-index_method-5 nil (equal (eval (pyel "pyel_test_index_method_358(1)")) 5))
(ert-deftest pyel-test-index_method-6 nil (equal (eval (pyel "pyel_test_index_method_358(2)")) 3))
(ert-deftest pyel-test-index_method-7 nil (equal (eval (pyel "pyel_test_index_method_358(3)")) 14))
(ert-deftest pyel-test-index_method-8 nil (equal (eval (pyel "pyel_test_index_method_358(4)")) 0))
(ert-deftest pyel-test-index_method-9 nil (equal (eval (pyel "pyel_test_index_method_359(1)")) 0))
(ert-deftest pyel-test-index_method-10 nil (equal (eval (pyel "pyel_test_index_method_359(2)")) 1))
(ert-deftest pyel-test-index_method-11 nil (equal (eval (pyel "pyel_test_index_method_359(3)")) 2))
(ert-deftest pyel-test-remove_method-1 nil (equal (eval (pyel "pyel_test_remove_method_360()")) (quote (1 "2" "2"))))
(ert-deftest pyel-test-remove_method-2 nil (equal (eval (pyel "pyel_test_remove_method_361()")) (quote ("2" "2" [1]))))
(ert-deftest pyel-test-remove_method-3 nil (equal (eval (pyel "pyel_test_remove_method_362()")) (quote (1 "2" [1]))))
(ert-deftest pyel-test-remove_method-4 nil (equal (eval (pyel "pyel_test_remove_method_363()")) t))
(ert-deftest pyel-test-count_method-2 nil (equal (eval (pyel "pyel_test_count_method_364(1)")) 2))
(ert-deftest pyel-test-count_method-3 nil (equal (eval (pyel "pyel_test_count_method_364(2)")) 1))
(ert-deftest pyel-test-count_method-4 nil (equal (eval (pyel "pyel_test_count_method_364(3)")) 1))
(ert-deftest pyel-test-count_method-5 nil (equal (eval (pyel "pyel_test_count_method_364(4)")) 1))
(ert-deftest pyel-test-count_method-6 nil (equal (eval (pyel "pyel_test_count_method_365(1)")) 2))
(ert-deftest pyel-test-count_method-7 nil (equal (eval (pyel "pyel_test_count_method_365(2)")) 1))
(ert-deftest pyel-test-count_method-8 nil (equal (eval (pyel "pyel_test_count_method_365(3)")) 1))
(ert-deftest pyel-test-count_method-9 nil (equal (eval (pyel "pyel_test_count_method_365(4)")) 1))
(ert-deftest pyel-test-extend_method-1 nil (equal (eval (pyel "pyel_test_extend_method_366(1)")) t))
(ert-deftest pyel-test-extend_method-2 nil (equal (eval (pyel "pyel_test_extend_method_366(2)")) (quote (1 "5" "4" "3" "2" "1"))))
(ert-deftest pyel-test-extend_method-3 nil (equal (eval (pyel "pyel_test_extend_method_367(1)")) t))
(ert-deftest pyel-test-extend_method-4 nil (equal (eval (pyel "pyel_test_extend_method_367(2)")) (quote (1 "e" "x" "t" "e" "n" "d" "e" "d"))))
(ert-deftest pyel-test-extend_method-5 nil (equal (eval (pyel "pyel_test_extend_method_368(1)")) t))
(ert-deftest pyel-test-extend_method-6 nil (equal (eval (pyel "pyel_test_extend_method_368(2)")) (quote (1 1 "2" [3]))))
(ert-deftest pyel-test-extend_method-7 nil (equal (eval (pyel "pyel_test_extend_method_369(1)")) t))
(ert-deftest pyel-test-extend_method-8 nil (equal (eval (pyel "pyel_test_extend_method_369(2)")) (quote (1 1 "2" [3]))))
(ert-deftest pyel-test-pop_method-1 nil (equal (eval (pyel "pyel_test_pop_method_370(1)")) "two"))
(ert-deftest pyel-test-pop_method-2 nil (equal (eval (pyel "pyel_test_pop_method_370(2)")) "{1: \"one\", 3: \"three\"}"))
(ert-deftest pyel-test-pop_method-3 nil (equal (eval (pyel "pyel_test_pop_method_371(1)")) 4))
(ert-deftest pyel-test-pop_method-4 nil (equal (eval (pyel "pyel_test_pop_method_371(2)")) (quote (1))))
(ert-deftest pyel-test-pop_method-5 nil (equal (eval (pyel "pyel_test_pop_method_371(3)")) 1))
(ert-deftest pyel-test-pop_method-6 nil (equal (eval (pyel "pyel_test_pop_method_371(4)")) t))
(ert-deftest pyel-test-reverse_method-1 nil (equal (eval (pyel "pyel_test_reverse_method_372(1)")) (quote (3 2 1))))
(ert-deftest pyel-test-reverse_method-2 nil (equal (eval (pyel "pyel_test_reverse_method_372(2)")) t))
(ert-deftest pyel-test-lower_method-1 nil (equal (eval (pyel "pyel_test_lower_method_373(1)")) "ab"))
(ert-deftest pyel-test-lower_method-2 nil (equal (eval (pyel "pyel_test_lower_method_373(2)")) "aB"))
(ert-deftest pyel-test-upper_method-1 nil (equal (eval (pyel "pyel_test_upper_method_374(1)")) "AB"))
(ert-deftest pyel-test-upper_method-2 nil (equal (eval (pyel "pyel_test_upper_method_374(2)")) "aB"))
(ert-deftest pyel-test-split_method-1 nil (equal (eval (pyel "pyel_test_split_method_375(1)")) (quote ("a" "x" "b" "x" "d" "x"))))
(ert-deftest pyel-test-split_method-2 nil (equal (eval (pyel "pyel_test_split_method_375(2)")) 6))
(ert-deftest pyel-test-split_method-4 nil (equal (eval (pyel "pyel_test_split_method_376()")) (quote ("a" "b" "c"))))
(ert-deftest pyel-test-strip_method-1 nil (equal (eval (pyel "pyel_test_strip_method_377()")) "e"))
(ert-deftest pyel-test-get_method-1 nil (equal (eval (pyel "pyel_test_get_method_378(1)")) "one"))
(ert-deftest pyel-test-get_method-2 nil (equal (eval (pyel "pyel_test_get_method_378(2)")) t))
(ert-deftest pyel-test-get_method-3 nil (equal (eval (pyel "pyel_test_get_method_378(3)")) "three"))
(ert-deftest pyel-test-get_method-4 nil (equal (eval (pyel "pyel_test_get_method_378(4)")) "d"))
(ert-deftest pyel-test-items_method-1 nil (equal (eval (pyel "pyel_test_items_method_379(1)")) (quote ((3 "three") (2 "two") (1 "one")))))
(ert-deftest pyel-test-items_method-2 nil (equal (eval (pyel "pyel_test_items_method_379(2)")) (quote ((8 88)))))
(ert-deftest pyel-test-items_method-3 nil (equal (eval (pyel "pyel_test_items_method_379(3)")) nil))
(ert-deftest pyel-test-keys_method-1 nil (equal (eval (pyel "pyel_test_keys_method_380(1)")) (quote (3 2 1))))
(ert-deftest pyel-test-keys_method-2 nil (equal (eval (pyel "pyel_test_keys_method_380(2)")) (quote ((8)))))
(ert-deftest pyel-test-keys_method-3 nil (equal (eval (pyel "pyel_test_keys_method_380(3)")) nil))
(ert-deftest pyel-test-values_method-1 nil (equal (eval (pyel "pyel_test_values_method_381(1)")) (quote ("three" "two" "one"))))
(ert-deftest pyel-test-values_method-2 nil (equal (eval (pyel "pyel_test_values_method_381(2)")) (quote (88))))
(ert-deftest pyel-test-values_method-3 nil (equal (eval (pyel "pyel_test_values_method_381(3)")) nil))
(ert-deftest pyel-test-popitem_method-1 nil (equal (eval (pyel "pyel_test_popitem_method_382(1)")) (quote (1 "one"))))
(ert-deftest pyel-test-popitem_method-2 nil (equal (eval (pyel "pyel_test_popitem_method_382(2)")) "{2: \"two\", 3: \"three\"}"))
(ert-deftest pyel-test-copy_method-1 nil (equal (eval (pyel "pyel_test_copy_method_383(1)")) nil))
(ert-deftest pyel-test-copy_method-2 nil (equal (eval (pyel "pyel_test_copy_method_383(2)")) t))
(ert-deftest pyel-test-islower_method-4 nil (equal (eval (pyel "pyel_test_islower_method_384(1)")) nil))
(ert-deftest pyel-test-islower_method-5 nil (equal (eval (pyel "pyel_test_islower_method_384(2)")) t))
(ert-deftest pyel-test-islower_method-6 nil (equal (eval (pyel "pyel_test_islower_method_384(3)")) nil))
(ert-deftest pyel-test-isupper_method-4 nil (equal (eval (pyel "pyel_test_isupper_method_385(1)")) t))
(ert-deftest pyel-test-isupper_method-5 nil (equal (eval (pyel "pyel_test_isupper_method_385(2)")) nil))
(ert-deftest pyel-test-isupper_method-6 nil (equal (eval (pyel "pyel_test_isupper_method_385(3)")) nil))
(ert-deftest pyel-test-istitle_method-5 nil (equal (eval (pyel "pyel_test_istitle_method_386(1)")) nil))
(ert-deftest pyel-test-istitle_method-6 nil (equal (eval (pyel "pyel_test_istitle_method_386(2)")) t))
(ert-deftest pyel-test-istitle_method-7 nil (equal (eval (pyel "pyel_test_istitle_method_386(3)")) nil))
(ert-deftest pyel-test-isalpha_method-1 nil (equal (eval (pyel "pyel_test_isalpha_method_387()")) t))
(ert-deftest pyel-test-isalnum_method-1 nil (equal (eval (pyel "pyel_test_isalnum_method_388()")) t))
(ert-deftest pyel-test-zfill_method-4 nil (equal (eval (pyel "pyel_test_zfill_method_389()")) "000000asdf"))
(ert-deftest pyel-test-title_method-1 nil (equal (eval (pyel "pyel_test_title_method_390()")) "2dd"))
(ert-deftest pyel-test-swapcase_method-1 nil (equal (eval (pyel "pyel_test_swapcase_method_391()")) "AAbb1"))
(ert-deftest pyel-test-startswith_method-3 nil (equal (eval (pyel "pyel_test_startswith_method_392()")) nil))
(ert-deftest pyel-test-rstrip_method-1 nil (equal (eval (pyel "pyel_test_rstrip_method_393()")) "he"))
(ert-deftest pyel-test-lstrip_method-1 nil (equal (eval (pyel "pyel_test_lstrip_method_394()")) "ello"))
(ert-deftest pyel-test-rsplit_method-1 nil (equal (eval (pyel "pyel_test_rsplit_method_395(1)")) (quote ("a" "x" "b" "x" "d" "x"))))
(ert-deftest pyel-test-rsplit_method-2 nil (equal (eval (pyel "pyel_test_rsplit_method_395(2)")) 6))
(ert-deftest pyel-test-rsplit_method-4 nil (equal (eval (pyel "pyel_test_rsplit_method_396()")) (quote ("a" "b" "c"))))
(ert-deftest pyel-test-partition_method-1 nil (equal (eval (pyel "pyel_test_partition_method_397()")) ["ab" "c" "defghi"]))
(ert-deftest pyel-test-rpartition_method-1 nil (equal (eval (pyel "pyel_test_rpartition_method_398()")) ["ab" "c" "defghi"]))
(ert-deftest pyel-test-rjust_method-1 nil (equal (eval (pyel "pyel_test_rjust_method_399()")) "        ab"))
(ert-deftest pyel-test-ljust_method-1 nil (equal (eval (pyel "pyel_test_ljust_method_400()")) "ab        "))
(ert-deftest pyel-test-rfind_method-1 nil (equal (eval (pyel "pyel_test_rfind_method_401(1)")) 1))
(ert-deftest pyel-test-rfind_method-2 nil (equal (eval (pyel "pyel_test_rfind_method_401(2)")) 6))
(ert-deftest pyel-el-ast-test-conditional-expressions-337 nil (string= (pyel "1 if True else 0" nil nil t) "(if-exp (name  \"True\" 'load 1 5) (num 1 1 0) (num 0 1 15) 1 0)
"))
(ert-deftest pyel-py-ast-test-conditional-expressions-336 nil (equal (py-ast "1 if True else 0") "Module(body=[Expr(value=IfExp(test=Name(id='True', ctx=Load()), body=Num(n=1), orelse=Num(n=0)))])
"))
(ert-deftest pyel-transform-test-conditional-expressions-335 nil (equal (pyel "1 if True else 0") (quote (if t 1 0))))
(ert-deftest pyel-el-ast-test-conditional-expressions-334 nil (string= (pyel "true() if tst() else false()" nil nil t) "(if-exp (call  (name  \"tst\" 'load 1 10) nil nil nil nil 1 10) (call  (name  \"true\" 'load 1 0) nil nil nil nil 1 0) (call  (name  \"false\" 'load 1 21) nil nil nil nil 1 21) 1 0)
"))
(ert-deftest pyel-py-ast-test-conditional-expressions-333 nil (equal (py-ast "true() if tst() else false()") "Module(body=[Expr(value=IfExp(test=Call(func=Name(id='tst', ctx=Load()), args=[], keywords=[], starargs=None, kwargs=None), body=Call(func=Name(id='true', ctx=Load()), args=[], keywords=[], starargs=None, kwargs=None), orelse=Call(func=Name(id='false', ctx=Load()), args=[], keywords=[], starargs=None, kwargs=None)))])
"))
(ert-deftest pyel-transform-test-conditional-expressions-332 nil (equal (pyel "true() if tst() else false()") (quote (if (pyel-fcall tst) (pyel-fcall true) (pyel-fcall false)))))
(ert-deftest pyel-el-ast-test-conditional-expressions-331 nil (string= (pyel "a[1] if a[2:2] else a[2]" nil nil t) "(if-exp (subscript (name  \"a\" 'load 1 8) (slice (num 2 1 10) (num 2 1 12) nil) 'load 1 8) (subscript (name  \"a\" 'load 1 0) (index (num 1 1 2) nil nil) 'load 1 0) (subscript (name  \"a\" 'load 1 20) (index (num 2 1 22) nil nil) 'load 1 20) 1 0)
"))
(ert-deftest pyel-py-ast-test-conditional-expressions-330 nil (equal (py-ast "a[1] if a[2:2] else a[2]") "Module(body=[Expr(value=IfExp(test=Subscript(value=Name(id='a', ctx=Load()), slice=Slice(lower=Num(n=2), upper=Num(n=2), step=None), ctx=Load()), body=Subscript(value=Name(id='a', ctx=Load()), slice=Index(value=Num(n=1)), ctx=Load()), orelse=Subscript(value=Name(id='a', ctx=Load()), slice=Index(value=Num(n=2)), ctx=Load())))])
"))
(ert-deftest pyel-transform-test-conditional-expressions-329 nil (equal (pyel "a[1] if a[2:2] else a[2]") (quote (if (pyel-subscript-load-slice a 2 2 nil) (pyel-subscript-load-index a 1) (pyel-subscript-load-index a 2)))))
(ert-deftest pyel-el-ast-test-boolop-328 nil (string= (pyel "a or b" nil nil t) "(boolop or ((name  \"a\" 'load 1 0) (name  \"b\" 'load 1 5)) 1 0)
"))
(ert-deftest pyel-py-ast-test-boolop-327 nil (equal (py-ast "a or b") "Module(body=[Expr(value=BoolOp(op=Or(), values=[Name(id='a', ctx=Load()), Name(id='b', ctx=Load())]))])
"))
(ert-deftest pyel-transform-test-boolop-326 nil (equal (pyel "a or b") (quote (or a b))))
(ert-deftest pyel-el-ast-test-boolop-325 nil (string= (pyel "a or b or c" nil nil t) "(boolop or ((name  \"a\" 'load 1 0) (name  \"b\" 'load 1 5) (name  \"c\" 'load 1 10)) 1 0)
"))
(ert-deftest pyel-py-ast-test-boolop-324 nil (equal (py-ast "a or b or c") "Module(body=[Expr(value=BoolOp(op=Or(), values=[Name(id='a', ctx=Load()), Name(id='b', ctx=Load()), Name(id='c', ctx=Load())]))])
"))
(ert-deftest pyel-transform-test-boolop-323 nil (equal (pyel "a or b or c") (quote (or a b c))))
(ert-deftest pyel-el-ast-test-boolop-322 nil (string= (pyel "a.c or b.c() or a[2]" nil nil t) "(boolop or ((attribute  (name  \"a\" 'load 1 0) \"c\" 'load 1 0) (call  (attribute  (name  \"b\" 'load 1 7) \"c\" 'load 1 7) nil nil nil nil 1 7) (subscript (name  \"a\" 'load 1 16) (index (num 2 1 18) nil nil) 'load 1 16)) 1 0)
"))
(ert-deftest pyel-py-ast-test-boolop-321 nil (equal (py-ast "a.c or b.c() or a[2]") "Module(body=[Expr(value=BoolOp(op=Or(), values=[Attribute(value=Name(id='a', ctx=Load()), attr='c', ctx=Load()), Call(func=Attribute(value=Name(id='b', ctx=Load()), attr='c', ctx=Load()), args=[], keywords=[], starargs=None, kwargs=None), Subscript(value=Name(id='a', ctx=Load()), slice=Index(value=Num(n=2)), ctx=Load())]))])
"))
(ert-deftest pyel-transform-test-boolop-320 nil (equal (pyel "a.c or b.c() or a[2]") (quote (or (getattr a c) (call-method b c) (pyel-subscript-load-index a 2)))))
(ert-deftest pyel-el-ast-test-boolop-319 nil (string= (pyel "a and b" nil nil t) "(boolop and ((name  \"a\" 'load 1 0) (name  \"b\" 'load 1 6)) 1 0)
"))
(ert-deftest pyel-py-ast-test-boolop-318 nil (equal (py-ast "a and b") "Module(body=[Expr(value=BoolOp(op=And(), values=[Name(id='a', ctx=Load()), Name(id='b', ctx=Load())]))])
"))
(ert-deftest pyel-transform-test-boolop-317 nil (equal (pyel "a and b") (quote (and a b))))
(ert-deftest pyel-el-ast-test-boolop-316 nil (string= (pyel "a and b or c" nil nil t) "(boolop or ((boolop and ((name  \"a\" 'load 1 0) (name  \"b\" 'load 1 6)) 1 0) (name  \"c\" 'load 1 11)) 1 0)
"))
(ert-deftest pyel-py-ast-test-boolop-315 nil (equal (py-ast "a and b or c") "Module(body=[Expr(value=BoolOp(op=Or(), values=[BoolOp(op=And(), values=[Name(id='a', ctx=Load()), Name(id='b', ctx=Load())]), Name(id='c', ctx=Load())]))])
"))
(ert-deftest pyel-transform-test-boolop-314 nil (equal (pyel "a and b or c") (quote (or (and a b) c))))
(ert-deftest pyel-el-ast-test-boolop-313 nil (string= (pyel "a[2] and b.f() or c.e" nil nil t) "(boolop or ((boolop and ((subscript (name  \"a\" 'load 1 0) (index (num 2 1 2) nil nil) 'load 1 0) (call  (attribute  (name  \"b\" 'load 1 9) \"f\" 'load 1 9) nil nil nil nil 1 9)) 1 0) (attribute  (name  \"c\" 'load 1 18) \"e\" 'load 1 18)) 1 0)
"))
(ert-deftest pyel-py-ast-test-boolop-312 nil (equal (py-ast "a[2] and b.f() or c.e") "Module(body=[Expr(value=BoolOp(op=Or(), values=[BoolOp(op=And(), values=[Subscript(value=Name(id='a', ctx=Load()), slice=Index(value=Num(n=2)), ctx=Load()), Call(func=Attribute(value=Name(id='b', ctx=Load()), attr='f', ctx=Load()), args=[], keywords=[], starargs=None, kwargs=None)]), Attribute(value=Name(id='c', ctx=Load()), attr='e', ctx=Load())]))])
"))
(ert-deftest pyel-transform-test-boolop-311 nil (equal (pyel "a[2] and b.f() or c.e") (quote (or (and (pyel-subscript-load-index a 2) (call-method b f)) (getattr c e)))))
(ert-deftest pyel-el-ast-test-boolop-310 nil (string= (pyel "a.e and b[2] or c.e() and 2 " nil nil t) "(boolop or ((boolop and ((attribute  (name  \"a\" 'load 1 0) \"e\" 'load 1 0) (subscript (name  \"b\" 'load 1 8) (index (num 2 1 10) nil nil) 'load 1 8)) 1 0) (boolop and ((call  (attribute  (name  \"c\" 'load 1 16) \"e\" 'load 1 16) nil nil nil nil 1 16) (num 2 1 26)) 1 16)) 1 0)
"))
(ert-deftest pyel-py-ast-test-boolop-309 nil (equal (py-ast "a.e and b[2] or c.e() and 2 ") "Module(body=[Expr(value=BoolOp(op=Or(), values=[BoolOp(op=And(), values=[Attribute(value=Name(id='a', ctx=Load()), attr='e', ctx=Load()), Subscript(value=Name(id='b', ctx=Load()), slice=Index(value=Num(n=2)), ctx=Load())]), BoolOp(op=And(), values=[Call(func=Attribute(value=Name(id='c', ctx=Load()), attr='e', ctx=Load()), args=[], keywords=[], starargs=None, kwargs=None), Num(n=2)])]))])
"))
(ert-deftest pyel-transform-test-boolop-308 nil (equal (pyel "a.e and b[2] or c.e() and 2 ") (quote (or (and (getattr a e) (pyel-subscript-load-index b 2)) (and (call-method c e) 2)))))
(ert-deftest pyel-el-ast-test-try-305 nil (string= (pyel "x = ''
try:
 1 / 0
 x = 'yes'
except:
...
"))
(ert-deftest pyel-py-ast-test-try-304 nil (equal (py-ast "x = ''
try:
 1 / 0
 x = 'yes'
except:
...
"))
(ert-deftest pyel-transform-test-try-303 nil (equal (pyel "x = ''
try:
 1 / 0
 x = 'yes'
except:
...
(ert-deftest pyel-el-ast-test-try-302 nil (string= (pyel "try:
 _a()
except:
 try:
  _x()
...
"))
(ert-deftest pyel-py-ast-test-try-301 nil (equal (py-ast "try:
 _a()
except:
 try:
  _x()
...
"))
(ert-deftest pyel-transform-test-try-300 nil (equal (pyel "try:
 _a()
except:
 try:
  _x()
...
(ert-deftest pyel-el-ast-test-lambda-292 nil (string= (pyel "lambda x,y,z=4,*g: print(z);x()" nil nil t) "(lambda ((arguments  ((arg \"x\"  nil) (arg \"y\"  nil) (arg \"z\"  nil)) g nil nil nil nil ((num 4 1 13)) nil )) ((call  (name  \"print\" 'load 1 19) ((name  \"z\" 'load 1 25)) nil nil nil 1 19)) 1 0)
(call  (name  \"x\" 'load 1 28) nil nil nil nil 1 28)
"))
(ert-deftest pyel-py-ast-test-lambda-291 nil (equal (py-ast "lambda x,y,z=4,*g: print(z);x()") "Module(body=[Expr(value=Lambda(args=arguments(args=[arg(arg='x', annotation=None), arg(arg='y', annotation=None), arg(arg='z', annotation=None)], vararg='g', varargannotation=None, kwonlyargs=[], kwarg=None, kwargannotation=None, defaults=[Num(n=4)], kw_defaults=[]), body=Call(func=Name(id='print', ctx=Load()), args=[Name(id='z', ctx=Load())], keywords=[], starargs=None, kwargs=None))), Expr(value=Call(func=Name(id='x', ctx=Load()), args=[], keywords=[], starargs=None, kwargs=None))])
"))
(ert-deftest pyel-transform-test-lambda-290 nil (equal (pyel "lambda x,y,z=4,*g: print(z);x()") (quote (progn (lambda (x y &optional z &rest g) nil (setq z (or z 4)) (py-print nil nil nil z)) (pyel-fcall x)))))
(ert-deftest pyel-el-ast-test-lambda-289 nil (string= (pyel "x = range(2, 9)
...
"))
(ert-deftest pyel-py-ast-test-lambda-288 nil (equal (py-ast "x = range(2, 9)
x2 = reduce(lambda a,b:a+b, x)
...
"))
(ert-deftest pyel-transform-test-lambda-287 nil (equal (pyel "x = range(2, 9)
x2 = reduce(lambda a,b:a+b, x)
...
(ert-deftest pyel-el-ast-test-global-286 nil (string= (pyel "def a():
 global x
 x = 3
...
"))
(ert-deftest pyel-py-ast-test-global-285 nil (equal (py-ast "def a():
 global x
 x = 3
...
"))
(ert-deftest pyel-transform-test-global-284 nil (equal (pyel "def a():
 global x
 x = 3
 y = 1") (quote (def a nil nil (let (y) (pyel-set x 3) (pyel-set y 1))))))
(ert-deftest pyel-el-ast-test-global-283 nil (string= (pyel "x = 1
y = 1
def func():
 global x
 x = 7
...
"))
(ert-deftest pyel-py-ast-test-global-282 nil (equal (py-ast "x = 1
y = 1
def func():
 global x
 x = 7
...
"))
(ert-deftest pyel-transform-test-global-281 nil (equal (pyel "x = 1
y = 1
def func():
 global x
 x = 7
...
(ert-deftest pyel-el-ast-test-assert-269 nil (string= (pyel "assert sldk()" nil nil t) "(assert  (call  (name  \"sldk\" 'load 1 7) nil nil nil nil 1 7) nil 1 0)
"))
(ert-deftest pyel-py-ast-test-assert-268 nil (equal (py-ast "assert sldk()") "Module(body=[Assert(test=Call(func=Name(id='sldk', ctx=Load()), args=[], keywords=[], starargs=None, kwargs=None), msg=None)])
"))
(ert-deftest pyel-transform-test-assert-267 nil (equal (pyel "assert sldk()") (quote (assert (pyel-fcall sldk) t nil))))
(ert-deftest pyel-el-ast-test-assert-266 nil (string= (pyel "assert adk,'messsage'" nil nil t) "(assert  (name  \"adk\" 'load 1 7) (str \"messsage\" 1 11) 1 0)
"))
(ert-deftest pyel-py-ast-test-assert-265 nil (equal (py-ast "assert adk,'messsage'") "Module(body=[Assert(test=Name(id='adk', ctx=Load()), msg=Str(s='messsage'))])
"))
(ert-deftest pyel-transform-test-assert-264 nil (equal (pyel "assert adk,'messsage'") (quote (assert adk t "messsage"))))
(ert-deftest pyel-el-ast-test-subscript-260 nil (string= (pyel "a = '1X23'
...
"))
(ert-deftest pyel-py-ast-test-subscript-259 nil (equal (py-ast "a = '1X23'
...
"))
(ert-deftest pyel-transform-test-subscript-258 nil (equal (pyel "a = '1X23'
...
(ert-deftest pyel-el-ast-test-subscript-254 nil (string= (pyel "a = (1,2,3,4)
assert a[1] == 2" nil nil t) "(assign  ((name  \"a\" 'store 1 0)) (tuple  ((num 1 1 5) (num 2 1 7) (num 3 1 9) (num 4 1 11)) 'load 1 5) 1 0)
(assert  (compare  (subscript (name  \"a\" 'load 2 7) (index (num 1 2 9) nil nil) 'load 2 7) (\"==\") ((num 2 2 15)) 2 7) nil 2 0)
"))
(ert-deftest pyel-py-ast-test-subscript-253 nil (equal (py-ast "a = (1,2,3,4)
...
"))
(ert-deftest pyel-transform-test-subscript-252 nil (equal (pyel "a = (1,2,3,4)
assert a[1] == 2") (quote (progn (pyel-set a (vector 1 2 3 4)) (assert (pyel-== (pyel-subscript-load-index a 1) 2) t nil)))))
(ert-deftest pyel-el-ast-test-subscript-251 nil (string= (pyel "class a:
...
"))
(ert-deftest pyel-py-ast-test-subscript-250 nil (equal (py-ast "class a:
 def __getitem__ (self, value):
  return value + 4
x = a()
...
"))
(ert-deftest pyel-transform-test-subscript-249 nil (equal (pyel "class a:
 def __getitem__ (self, value):
  return value + 4
x = a()
...
(ert-deftest pyel-el-ast-test-subscript-245 nil (string= (pyel "a = [1,2,3,4,5]
assert a[1:4] == [2,3,4]
assert a[:4] == [1,2,3,4]
assert a[2:] == [3,4,5]
...
"))
(ert-deftest pyel-py-ast-test-subscript-244 nil (equal (py-ast "a = [1,2,3,4,5]
assert a[1:4] == [2,3,4]
assert a[:4] == [1,2,3,4]
assert a[2:] == [3,4,5]
...
"))
(ert-deftest pyel-transform-test-subscript-243 nil (equal (pyel "a = [1,2,3,4,5]
assert a[1:4] == [2,3,4]
assert a[:4] == [1,2,3,4]
assert a[2:] == [3,4,5]
...
(ert-deftest pyel-el-ast-test-subscript-242 nil (string= (pyel "a = '012345678'
assert a[1:4] == '123'
assert a[:4] == '0123'
assert a[2:] == '2345678'
...
"))
(ert-deftest pyel-py-ast-test-subscript-241 nil (equal (py-ast "a = '012345678'
assert a[1:4] == '123'
assert a[:4] == '0123'
assert a[2:] == '2345678'
...
"))
(ert-deftest pyel-transform-test-subscript-240 nil (equal (pyel "a = '012345678'
assert a[1:4] == '123'
assert a[:4] == '0123'
assert a[2:] == '2345678'
...
(ert-deftest pyel-el-ast-test-subscript-239 nil (string= (pyel "class a:
 def __getitem__ (self, value):
...
"))
(ert-deftest pyel-py-ast-test-subscript-238 nil (equal (py-ast "class a:
 def __getitem__ (self, value):
  return value.start + value.end
x = a()
assert x[1:2] == 3
...
"))
(ert-deftest pyel-transform-test-subscript-237 nil (equal (pyel "class a:
 def __getitem__ (self, value):
  return value.start + value.end
x = a()
assert x[1:2] == 3
...
(ert-deftest pyel-el-ast-test-subscript-236 nil (string= (pyel "def __add(a,b):
 return a+b
a = [1,2,3,4]
a[0] = __add(a[1],a[2])
assert a[0] == 5
...
"))
(ert-deftest pyel-py-ast-test-subscript-235 nil (equal (py-ast "def __add(a,b):
 return a+b
a = [1,2,3,4]
a[0] = __add(a[1],a[2])
assert a[0] == 5
...
"))
(ert-deftest pyel-transform-test-subscript-234 nil (equal (pyel "def __add(a,b):
 return a+b
a = [1,2,3,4]
a[0] = __add(a[1],a[2])
assert a[0] == 5
...
(ert-deftest pyel-el-ast-test-subscript-233 nil (string= (pyel "a = (1,2,3,4)
a[0] = a[1] + a[2]
assert aa[0] == 5
a[2] = 'str'
...
"))
(ert-deftest pyel-py-ast-test-subscript-232 nil (equal (py-ast "a = (1,2,3,4)
a[0] = a[1] + a[2]
assert aa[0] == 5
a[2] = 'str'
...
"))
(ert-deftest pyel-transform-test-subscript-231 nil (equal (pyel "a = (1,2,3,4)
a[0] = a[1] + a[2]
assert aa[0] == 5
a[2] = 'str'
...
(ert-deftest pyel-el-ast-test-subscript-230 nil (string= (pyel "class a:
...
"))
(ert-deftest pyel-py-ast-test-subscript-229 nil (equal (py-ast "class a:
 def __setitem__ (self, index, value):
  self.index = index
  self.value = value
x = a()
...
"))
(ert-deftest pyel-transform-test-subscript-228 nil (equal (pyel "class a:
 def __setitem__ (self, index, value):
  self.index = index
  self.value = value
x = a()
...
(ert-deftest pyel-el-ast-test-subscript-224 nil (string= (pyel "a = (1,2,3,4,5,6)
a[1:4] = (5,4,'f')
assert a == (1,5,4,'f',5,6)
a[:3] = ('a',4,2.2)
assert a == ('a',4,2.2,'f',5,6)
...
"))
(ert-deftest pyel-py-ast-test-subscript-223 nil (equal (py-ast "a = (1,2,3,4,5,6)
a[1:4] = (5,4,'f')
assert a == (1,5,4,'f',5,6)
a[:3] = ('a',4,2.2)
assert a == ('a',4,2.2,'f',5,6)
...
"))
(ert-deftest pyel-transform-test-subscript-222 nil (equal (pyel "a = (1,2,3,4,5,6)
a[1:4] = (5,4,'f')
assert a == (1,5,4,'f',5,6)
a[:3] = ('a',4,2.2)
assert a == ('a',4,2.2,'f',5,6)
...
(ert-deftest pyel-el-ast-test-subscript-221 nil (string= (pyel "a = '123456'
a[1:4] = '54f'
assert a == '154f56'
a[:3] = 'a42'
assert a == 'a42f56'
...
"))
(ert-deftest pyel-py-ast-test-subscript-220 nil (equal (py-ast "a = '123456'
a[1:4] = '54f'
assert a == '154f56'
a[:3] = 'a42'
assert a == 'a42f56'
...
"))
(ert-deftest pyel-transform-test-subscript-219 nil (equal (pyel "a = '123456'
a[1:4] = '54f'
assert a == '154f56'
a[:3] = 'a42'
assert a == 'a42f56'
...
(ert-deftest pyel-el-ast-test-subscript-218 nil (string= (pyel "class a:
 def __setitem__ (self, index, value):
...
"))
(ert-deftest pyel-py-ast-test-subscript-217 nil (equal (py-ast "class a:
 def __setitem__ (self, index, value):
  self.start = index.start
  self.end = index.end
  self.step = index.step
...
"))
(ert-deftest pyel-transform-test-subscript-216 nil (equal (pyel "class a:
 def __setitem__ (self, index, value):
  self.start = index.start
  self.end = index.end
  self.step = index.step
...
(ert-deftest pyel-el-ast-test-subscript-215 nil (string= (pyel "a[2] += 3" nil nil t) "(aug-assign (subscript (name  \"a\" 'load 1 0) (index (num 2 1 2) nil nil) 'store 1 0) + (num 3 1 8) 1 0)
"))
(ert-deftest pyel-py-ast-test-subscript-214 nil (equal (py-ast "a[2] += 3") "Module(body=[AugAssign(target=Subscript(value=Name(id='a', ctx=Load()), slice=Index(value=Num(n=2)), ctx=Store()), op=Add(), value=Num(n=3))])
"))
(ert-deftest pyel-transform-test-subscript-213 nil (equal (pyel "a[2] += 3") (quote (pyel-subscript-store-index a 2 (pyel-+ (pyel-subscript-load-index a 2) 3)))))
(ert-deftest pyel-el-ast-test-subscript-212 nil (string= (pyel "a[2] += b[3]" nil nil t) "(aug-assign (subscript (name  \"a\" 'load 1 0) (index (num 2 1 2) nil nil) 'store 1 0) + (subscript (name  \"b\" 'load 1 8) (index (num 3 1 10) nil nil) 'load 1 8) 1 0)
"))
(ert-deftest pyel-py-ast-test-subscript-211 nil (equal (py-ast "a[2] += b[3]") "Module(body=[AugAssign(target=Subscript(value=Name(id='a', ctx=Load()), slice=Index(value=Num(n=2)), ctx=Store()), op=Add(), value=Subscript(value=Name(id='b', ctx=Load()), slice=Index(value=Num(n=3)), ctx=Load()))])
"))
(ert-deftest pyel-transform-test-subscript-210 nil (equal (pyel "a[2] += b[3]") (quote (pyel-subscript-store-index a 2 (pyel-+ (pyel-subscript-load-index a 2) (pyel-subscript-load-index b 3))))))
(ert-deftest pyel-el-ast-test-subscript-209 nil (string= (pyel "[2,3,3][2]" nil nil t) "(subscript (list ((num 2 1 1) (num 3 1 3) (num 3 1 5)) 'load 1 0) (index (num 2 1 8) nil nil) 'load 1 0)
"))
(ert-deftest pyel-py-ast-test-subscript-208 nil (equal (py-ast "[2,3,3][2]") "Module(body=[Expr(value=Subscript(value=List(elts=[Num(n=2), Num(n=3), Num(n=3)], ctx=Load()), slice=Index(value=Num(n=2)), ctx=Load()))])
"))
(ert-deftest pyel-transform-test-subscript-207 nil (equal (pyel "[2,3,3][2]") (quote (pyel-subscript-load-index (list 2 3 3) 2))))
...
"))
(ert-deftest pyel-py-ast-test-subscript-205 nil (equal (py-ast "assert [1,2,(3,2,8)][2][2] == 8") "Module(body=[Assert(test=Compare(left=Subscript(value=Subscript(value=List(elts=[Num(n=1), Num(n=2), Tuple(elts=[Num(n=3), Num(n=2), Num(n=8)], ctx=Load())], ctx=Load()), slice=Index(value=Num(n=2)), ctx=Load()), slice=Index(value=Num(n=2)), ctx=Load()), ops=[Eq()], comparators=[Num(n=8)]), msg=None)])
"))
(ert-deftest pyel-transform-test-subscript-204 nil (equal (pyel "assert [1,2,(3,2,8)][2][2] == 8") (quote (assert (pyel-== (pyel-subscript-load-index (pyel-subscript-load-index (list 1 2 (vector 3 2 8)) 2) 2) 8) t nil))))
